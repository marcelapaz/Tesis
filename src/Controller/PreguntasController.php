...
class PreguntasController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Preguntas->save($pregunta)) {
                $this->Flash->success('The pregunta has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The pregunta could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Preguntas->delete($pregunta)) {
            $this->Flash->success('The pregunta has been deleted.');
        } else {
            $this->Flash->error('The pregunta could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
